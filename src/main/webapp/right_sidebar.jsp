			...
			<div class="row">
				...
				<div class="col-md-12">
					<div class="crumbs">
						...
						<a href="#">Pages</a>
						<span class="crumbs-span">/</span>
						<span class="current">Page Right Sidebar</span>
					</div>
				</div>
			</div><!-- End row -->
		...
		<div class="row">
			<div class="col-md-9">
				<div class="page-content">
					<div class="boxedtitle page-title"><h2>Page Right Sidebar</h2></div>
					...
					<div class="video_embed"><iframe height="600" src="http://www.youtube.com/embed/JuyB7NO0EYY"></iframe></div>
