			...
			<div class="col-md-9">
						...
						<div class="carousel-all testimonial-carousel testimonial-warp-2" carousel_responsive="false" carousel_auto="false" carousel_effect="scroll">
							<div class="slides">
								<div class="testimonial-warp">
									...
									<div class="testimonial-client">
										<img src="../ask-me/images/demo/admin.jpg" alt="">
										<span>Ahmed Hassan<span> , Developer</span></span>
									</div>
								</div>
								<div class="testimonial-warp">
									...
									<div class="testimonial-client">
										<img src="../ask-me/images/demo/avatar.png" alt="">
										<span>Ahmed Hassan<span> , Developer</span></span>
									</div>
								</div>
								<div class="testimonial-warp">
				...
				<div id="icons" class="row">
					...
					<div class="col-md-4">
						<div class="page-content page-shortcode">
						    <div class="box_icon">
						        <span class="t_center icon_i"><span icon_size="120"><i i_color="#1abc9c" i_hover="#34495e" class="icon-tint color_default"></i></span></span>
						        <div class="t_center">
					...
					<div class="col-md-4">
					    <div class="page-content page-shortcode">
					        <div class="box_icon">
						        <span class="t_center icon_i"><span icon_size="50" span_bg="#1abc9c" span_hover="#34495e" class="icon_square"><i class="icon-desktop"></i></span></span>
						        <div class="t_center">
						            <h3>Responsive</h3>
						            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi adipiscing gravida odio.</p>
						        </div>
					...
					<div class="col-md-4">
					    <div class="page-content page-shortcode">
					        <div class="box_icon">
						        <span class="t_center icon_i"><span class="icon_circle" icon_size="50" span_bg="#1abc9c" span_hover="#34495e"><i class="icon-bullhorn"></i></span></span>
						        <div class="t_center">
						            <h3>Easy To Use</h3>
						            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi adipiscing gravida odio.</p>
						        </div>
				...
				<div id="bullet" class="row">
					...
					<div class="col-md-4">
						<div class="ul_list ul_list-icon-ok ul_list_circle" list_background="#1abc9c" list_background_hover="#34495E" list_color="#FFF">
							<ul>
								<li><i l_background="#1abc9c" l_background_hover="#34495E" class="icon-ok ul_l_circle"></i>Unlimited Colors</li>
				...
				<div id="slideShow" class="row">
					<div class="col-md-12">
						...
						<div class="flexslider flex-slider">
						    <ul class="slides">
						        <li>
						        	<img src="../ask-me/images/demo/posts/3d-cartoon-caracter2.jpg" alt="">
						        ...
						        <li>
						        	<img src="../ask-me/images/demo/posts/WebshotNature-250.jpg" alt="">
						        	<div class="flex-caption">
						        		<div class="text">
						        			<div class="flex_title"><h2>Lorem Ipsum</h2></div>
						        			<div class="flex_subtitle"><h3>simply dummy text of the printing and
							...
							<div class="slide">
								<div class="grid-bxslider">
									<div class="bxslider-overlay t_center">
									    ...
									    <a href="../shager/Light/images/demo/projects/Cartoons_016.jpg" class="prettyPhoto" rel="prettyPhoto"><span class="overlay-lightbox"><i class="icon-search"></i></span></a>
									    <a href="#"><span class="overlay-link"><i class="icon-link"></i></span></a>
									</div>
									<img src="../shager/Light/images/demo/projects/Cartoons_016-300x187.jpg" alt="">
								</div>
							</div>
							<div class="slide">
								<div class="grid-bxslider">
									<div class="bxslider-overlay t_center">
									    ...
									    <a href="../shager/Light/images/demo/projects/Adventure_Time_Cartoon_HD_Wallpaper-Jake.jpg" class="prettyPhoto" rel="prettyPhoto"><span class="overlay-lightbox"><i class="icon-search"></i></span></a>
									    <a href="#"><span class="overlay-link"><i class="icon-link"></i></span></a>
									</div>
									<img src="../shager/Light/images/demo/projects/Adventure_Time_Cartoon_HD_Wallpaper-Jake1-300x187.jpg" alt="">
								</div>
							</div>
							<div class="slide">
								<div class="grid-bxslider">
									<div class="bxslider-overlay t_center">
									    ...
									    <a href="../shager/Light/images/demo/projects/the-simpsons-family-cartoon-wallpaper-1680x1050.jpg" class="prettyPhoto" rel="prettyPhoto"><span class="overlay-lightbox"><i class="icon-search"></i></span></a>
									    <a href="#"><span class="overlay-link"><i class="icon-link"></i></span></a>
									</div>
									<img src="../shager/Light/images/demo/projects/the-simpsons-family-cartoon-wallpaper-1680x1050-300x187.jpg" alt="">
								</div>
							</div>
							<div class="slide">
								<div class="grid-bxslider">
									<div class="bxslider-overlay t_center">
									    ...
									    <a href="../shager/Light/images/demo/projects/Funny_Stewie_Griffin_Cartoon_HD_Wallpaper-Vvallpaper.Net_.jpg" class="prettyPhoto" rel="prettyPhoto"><span class="overlay-lightbox"><i class="icon-search"></i></span></a>
									    <a href="#"><span class="overlay-link"><i class="icon-link"></i></span></a>
									</div>
									<img src="../shager/Light/images/demo/projects/Funny_Stewie_Griffin_Cartoon_HD_Wallpaper-Vvallpaper.Net_-300x187.jpg" alt="">
								</div>
							</div>
							<div class="slide">
								<div class="grid-bxslider">
									<div class="bxslider-overlay t_center">
									    ...
									    <a href="../shager/Light/images/demo/projects/Houses_wallpapers_132.jpg" class="prettyPhoto" rel="prettyPhoto"><span class="overlay-lightbox"><i class="icon-search"></i></span></a>
									    <a href="#"><span class="overlay-link"><i class="icon-link"></i></span></a>
									</div>
									<img src="../shager/Light/images/demo/projects/Houses_wallpapers_132-300x187.jpg" alt="">
								</div>
							</div>
							<div class="slide">
								<div class="grid-bxslider">
									<div class="bxslider-overlay t_center">
									    ...
									    <a href="../shager/Light/images/demo/projects/Cartoon-boy-1280x800.jpg" class="prettyPhoto" rel="prettyPhoto"><span class="overlay-lightbox"><i class="icon-search"></i></span></a>
									    <a href="#"><span class="overlay-link"><i class="icon-link"></i></span></a>
									</div>
									<img src="../shager/Light/images/demo/projects/Cartoon-boy-1280x800-300x187.jpg" alt="">
								</div>
							</div>
							<div class="slide">
								<div class="grid-bxslider">
									<div class="bxslider-overlay t_center">
									    ...
									    <a href="../shager/Light/images/demo/projects/dr.-seuss-the-lorax-movie-animated-cartoon-wallpaper-1920x1200.jpg" class="prettyPhoto" rel="prettyPhoto"><span class="overlay-lightbox"><i class="icon-search"></i></span></a>
									    <a href="#"><span class="overlay-link"><i class="icon-link"></i></span></a>
									</div>
									<img src="../shager/Light/images/demo/projects/dr.-seuss-the-lorax-movie-animated-cartoon-wallpaper-1920x1200-300x187.jpg" alt="">
								</div>
							</div>
							<div class="slide">
								<div class="grid-bxslider">
									<div class="bxslider-overlay t_center">
									    ...
									    <a href="../shager/Light/images/demo/projects/Best-HD-Wallpapers-Pack-58.jpg" class="prettyPhoto" rel="prettyPhoto"><span class="overlay-lightbox"><i class="icon-search"></i></span></a>
									    <a href="#"><span class="overlay-link"><i class="icon-link"></i></span></a>
									</div>
									<img src="../shager/Light/images/demo/projects/Best-HD-Wallpapers-Pack-58-300x187.jpg" alt="">
								</div>
							</div>
						</div>
			...
			<aside class="col-md-3 sidebar">
				<div class="widget widget_menu widget_menu_jquery">
					<ul>
						...
						<li><a href="#alert"><i class="icon-bullhorn"></i>Alert Boxes</a></li>
						<li><a href="#buttons"><i class="icon-link"></i>Buttons</a></li>
						<li><a href="#testimonial"><i class="icon-thumbs-up"></i>Testimonial</a></li>
						<li><a href="#audio"><i class="icon-music"></i>Audio</a></li>
						<li><a href="#dropcaps"><i class="icon-bold"></i>Dropcaps</a></li>
						<li><a href="#blockquote"><i class="icon-quote-left"></i>Blockquote</a></li>
						<li><a href="#icons"><i class="icon-star-empty"></i>Icons</a></li>
						<li><a href="#contact"><i class="icon-envelope"></i>Contact Forms</a></li>
						<li><a href="#bullet"><i class="icon-list"></i>Bullet and Lists</a></li>
						<li><a href="#progess"><i class="icon-tasks"></i>Progess Bars</a></li>
						<li><a href="#slideShow"><i class="icon-picture"></i>SlideShow</a></li>
